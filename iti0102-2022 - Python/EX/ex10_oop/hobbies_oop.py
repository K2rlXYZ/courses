...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    sorted_list = sorted(sorted_list, key=lambda x: len(x.hobbies), reverse=True)
    return sorted_list
...
def sort_by_least_hobbies(people_list: list) -> list:
    ...
    :return: sorted list of people.
    """
    sorted_list = sorted(people_list, key=lambda x: (len(x.hobbies), x.full_name))
    return sorted_list
...
def sort_people_and_hobbies(people_list: list) -> list:
    ...
    :return: sorted list of people.
    """
    [person.hobbies.sort() for person in people_list]
